...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        ?>
        <title>Quản lí - Loại sản phẩm - Sửa - <?php echo $title; ?> </title>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            if (count($category) == 0) {
                                ...
                                echo form_open_multipart('quan-li/loai-san-pham/sua/' . $category[0]['CategoryID'], $Attributes);
                                ?>
                                <center>
                                ...
                                <?php
                                if ($flag == false) {
                                    echo '<div class="alert alert-warning" role="alert" id="failAlert">Bạn vẫn chưa thay đổi gì</div>';
                                } else {
                                    echo '<div class="alert alert-success" role="alert" id="successAlert" >Lưu trữ thành công</div>';
                                }
                                ?>
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-5 col-md-7">
                                            <?php echo form_submit($EditButton); ?>
                                            <input type="button" id="resetButton" value="Tải lại sản phẩm" class="btn btn-danger">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-5 col-md-7">
